            ...
            <section className="min-h-screen bg-fixed" style={{ backgroundImage: `linear-gradient(180deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0.92) 35%, rgba(0,0,0,0) 100%), linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.3) 35%, rgba(0,0,0,0.8) 100%), url(${movie.poster})`, backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
                ...
                <section className="pt-32 px-20 grid sm:grid-cols-1 lg:grid-cols-[minmax(900px,_1fr)_350px] gap-x-8">
                    ...
                    <article className="justify-self-center">
                        <img src={movie.poster} alt="" className="max-h-[450px] rounded-xl shadow-2xl shadow-neutral-400" />
                    </article>
